...
#define Publisher "dkmcgowan"
#define ExeName "finzy.exe"
...
AllowNoIcons=yes
OutputDir=.
OutputBaseFilename=finzy-windows-installer
Compression=lzma
...
Write-Host "Installer:        $(Join-Path $ResolvedOutput 'finzy-windows-installer.exe')" -ForegroundColor White
