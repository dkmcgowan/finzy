...
import com.dkmcgowan.finzy.exoplayer.ExoPlayerPlugin
import com.dkmcgowan.finzy.mpv.MpvPlayerPlugin
import com.dkmcgowan.finzy.watchnext.WatchNextPlugin
import java.io.File

class MainActivity : FlutterActivity() {

    private val PIP_CHANNEL = "app.finzy/pip"
    private val EXTERNAL_PLAYER_CHANNEL = "app.finzy/external_player"
                ...
                "openVideo" -> {
                    ...
                    try {
                        ...
                        if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
                            ...
                            uri = FileProvider.getUriForFile(this, "com.dkmcgowan.finzy.fileprovider", File(path))
                            grantRead = true
                        }
